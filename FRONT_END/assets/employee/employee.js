	...
	loadEmployeeTable = () => {
		...
		$("#employee_table").dataTable({
			...
			columns: [
				{
					...
					render: function (aData, type, row) {
						...
						photo +=
							"<img src='http://localhost:8000/assets/" +
							aData.photo +
			...
			fnRowCallback: function (nRow, aData, iDisplayIndex, iDisplayIndexFull) {
				...
				$("td:eq(4)", nRow).html(aData["job.job_title"]);
				...
				if (type == 0) {
					...
					$("#form_card_body").append(
						"<div class='row view_div'>" +
							...
							"<th>Birthdate</th>" +
							"<td>" +
							moment(data.birth_date).format("MMMM D, YYYY") +
							"</td>" +
							"</tr>" +
							"<tr>" +
							"<th>Phone Number</th>" +
							...
							"<th>Department</th>" +
							"<td>" +
							data.department.main_department_name +
							"</td>" +
							"</tr>" +
							"<tr>" +
							"<th>Job</th>" +
