    ...
    loadUserTable = () => {
      ...
      $("#user_table").dataTable({
        ...
        columns: [
          {
                      ...
                      render: function (aData, type, row) {
                          let full_name = "";
                          full_name +=
                              aData.employee.first_name + " " + aData.employee.last_name 
                          return full_name;
                      },
        ...
        fnRowCallback: function (nRow, aData, iDisplayIndex, iDisplayIndexFull) {
          ...
          $("td:eq(2)", nRow).html(aData["user_type.user_type"]);
    ...
    loadUserType= () => {
        $.ajax({
          ...
          success: function (data) {
            ...
            $("#user_type_id").append('<option value="" selected>Select User Type</option>');
          },
          error: function ({ responseJSON }) {
            // toastr.error(data.responseJSON.detail);
          },
